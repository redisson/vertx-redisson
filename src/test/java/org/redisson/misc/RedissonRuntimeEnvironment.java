...
public class RedissonRuntimeEnvironment {
    ...
    public static final String redisBinaryPath = System.getProperty("redisBinary", System.getenv().containsKey("REDIS_BIN") ? System.getenv("REDIS_BIN") : "C:\\Devel\\projects\\redis\\Redis-x64-3.2.100\\redis-server.exe");
