...
public class ClusterServersConfig {
    ...
    public ClusterServersConfig(JsonObject json) {
        this.json = json;
    }
     ...
     */
    @Fluent
    public ClusterServersConfig setSubscriptionsPerConnection(Integer subscriptionsPerConnection) {
     ...
     */
    @Fluent
    public ClusterServersConfig setRetryAttempts(Integer retryAttempts) {
     ...
     */
    @Fluent
    public ClusterServersConfig setRetryInterval(Integer retryInterval) {
     ...
     */
    @Fluent
    public ClusterServersConfig setTimeout(Integer timeout) {
     ...
     */
    @Fluent
    public ClusterServersConfig setPingTimeout(Integer pingTimeout) {
     ...
     */
    @Fluent
    public ClusterServersConfig setConnectTimeout(Integer connectTimeout) {
     ...
     */
    @Fluent
    public ClusterServersConfig setIdleConnectionTimeout(Integer idleConnectionTimeout) {
     ...
     */
    @Fluent
    public ClusterServersConfig setReconnectionTimeout(Integer reconnectionTimeout) {
     ...
     */
    @Fluent
    public ClusterServersConfig setFailedAttempts(Integer failedAttempts) {
     ...
     */
    @Fluent
    public ClusterServersConfig setSlaveConnectionPoolSize(Integer slaveConnectionPoolSize) {
     ...
     */
    @Fluent
    public ClusterServersConfig setMasterConnectionPoolSize(Integer masterConnectionPoolSize) {
     ...
     */
    @Fluent
    public ClusterServersConfig setLoadBalancer(String loadBalancer) {
     ...
     */
    @Fluent
    public ClusterServersConfig setSlaveSubscriptionConnectionPoolSize(Integer slaveSubscriptionConnectionPoolSize) {
     ...
     */
    @Fluent
    public ClusterServersConfig setSlaveConnectionMinimumIdleSize(Integer slaveConnectionMinimumIdleSize) {
     ...
     */
    @Fluent
    public ClusterServersConfig setMasterConnectionMinimumIdleSize(Integer masterConnectionMinimumIdleSize) {
     ...
     */
    @Fluent
    public ClusterServersConfig setSlaveSubscriptionConnectionMinimumIdleSize(Integer slaveSubscriptionConnectionMinimumIdleSize) {
    ...
    @Fluent
    public ClusterServersConfig setNodeAddresses(JsonArray slaveAddress) {
     ...
     */
    @Fluent
    public ClusterServersConfig setScanInterval(Integer scanInterval) {
