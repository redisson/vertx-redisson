...
public class SentinelServersConfig {
    ...
    public SentinelServersConfig(JsonObject json) {
        this.json = json;
    }
     ...
     */
    @Fluent
    public SentinelServersConfig setSubscriptionsPerConnection(Integer subscriptionsPerConnection) {
     ...
     */
    @Fluent
    public SentinelServersConfig setRetryAttempts(Integer retryAttempts) {
     ...
     */
    @Fluent
    public SentinelServersConfig setRetryInterval(Integer retryInterval) {
     ...
     */
    @Fluent
    public SentinelServersConfig setTimeout(Integer timeout) {
     ...
     */
    @Fluent
    public SentinelServersConfig setPingTimeout(Integer pingTimeout) {
     ...
     */
    @Fluent
    public SentinelServersConfig setConnectTimeout(Integer connectTimeout) {
     ...
     */
    @Fluent
    public SentinelServersConfig setIdleConnectionTimeout(Integer idleConnectionTimeout) {
     ...
     */
    @Fluent
    public SentinelServersConfig setReconnectionTimeout(Integer reconnectionTimeout) {
     ...
     */
    @Fluent
    public SentinelServersConfig setFailedAttempts(Integer failedAttempts) {
     ...
     */
    @Fluent
    public SentinelServersConfig setSlaveConnectionPoolSize(Integer slaveConnectionPoolSize) {
     ...
     */
    @Fluent
    public SentinelServersConfig setMasterConnectionPoolSize(Integer masterConnectionPoolSize) {
     ...
     */
    @Fluent
    public SentinelServersConfig setLoadBalancer(String loadBalancer) {
     ...
     */
    @Fluent
    public SentinelServersConfig setSlaveSubscriptionConnectionPoolSize(Integer slaveSubscriptionConnectionPoolSize) {
     ...
     */
    @Fluent
    public SentinelServersConfig setSlaveConnectionMinimumIdleSize(Integer slaveConnectionMinimumIdleSize) {
     ...
     */
    @Fluent
    public SentinelServersConfig setMasterConnectionMinimumIdleSize(Integer masterConnectionMinimumIdleSize) {
     ...
     */
    @Fluent
    public SentinelServersConfig setSlaveSubscriptionConnectionMinimumIdleSize(Integer slaveSubscriptionConnectionMinimumIdleSize) {
    ...
    public String getMasterName() {
        return json.getString("masterName");
    }
    ...
    public SentinelServersConfig addSentinelAddress(JsonArray addresses) {
        ...
        json.getJsonArray("sentinelAddresses").addAll(new JsonArray(l));
        return this;
    }
    ...
    public JsonArray getSentinelAddresses() {
        return json.getJsonArray("sentinelAddresses", new JsonArray());
    }
    
    @Fluent
    public SentinelServersConfig setSentinelAddresses(JsonArray slaveAddress) {
        json.put("sentinelAddresses", slaveAddress);
        return this;
    }
     ...
     * @return config
     */
    public SentinelServersConfig setDatabase(Integer database) {
